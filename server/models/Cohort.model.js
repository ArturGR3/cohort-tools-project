...
const cohortSchema = new Schema({
  ...
  format: { type: String, required: true, enum: ["Full Time", "Part Time"] },
  campus: { type: String, required: true, enum: ["Madrid", "Barcelona", "Miami", "Paris", "Berlin", "Amsterdam", "Lisbon", "Remote"] },
